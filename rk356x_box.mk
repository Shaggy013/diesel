...
#    ro.com.google.clientidbase=android-rockchip-tv
   ro.com.google.clientidbase=android-askey-tv
...
PRODUCT_COPY_FILES += \
    $(TARGET_DEVICE_DIR)/default-permissions/default-permissions.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/default-permissions/default-permissions.xml \
    $(TARGET_DEVICE_DIR)/default-permissions/default-permissions-google.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/default-permissions/default-permissions-google.xml \
    $(TARGET_DEVICE_DIR)/default-permissions/opengapps-permissions.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/default-permissions/opengapps-permissions.xml
#
